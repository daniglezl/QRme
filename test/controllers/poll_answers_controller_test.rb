...
class PollAnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll_answer" do
    assert_difference('PollAnswer.count') do
      post poll_answers_url, params: { poll_answer: { poll_id: @poll_answer.poll_id, title: @poll_answer.title, voteCount: @poll_answer.voteCount } }
    end
  ...
  test "should update poll_answer" do
    patch poll_answer_url(@poll_answer), params: { poll_answer: { poll_id: @poll_answer.poll_id, title: @poll_answer.title, voteCount: @poll_answer.voteCount } }
